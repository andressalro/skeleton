...
import { ResolveReceiptTemplateService } from './resolve-receipt-template.service'
...
import { PdfDocumentGenerationService } from './generate-pdf-document.service'
import { PdfBuilder, TemplateEngine } from './types'
...
> {
  ...
  private readonly resolveReceiptTemplate: ResolveReceiptTemplateService
  ...
  constructor(
    ...
    this.resolveReceiptTemplate = new ResolveReceiptTemplateService(
      templateRepository
    )
